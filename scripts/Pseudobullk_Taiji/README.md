1. download single cell experiment data from GEO [GSE231384](https://0-www-ncbi-nlm-nih-gov.brum.beds.ac.uk/geo/query/acc.cgi?acc=GSE231384), raw sequencing data can be obtained from the associated SRA.
